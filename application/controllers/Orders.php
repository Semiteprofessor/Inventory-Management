	...
	public function printDiv($id)
	{
		...
		if($id) {
			...
			<div class="wrapper">
			  <section>
			    ...
			    <div class="row">
			      <div class="col-xs-12">
			        <h3>
				  <img src="' . base_url('assets/images/swich.png') . '" alt="" width="30" height="30" >
			    ...
			    <div class="row "><small>
			      ...
			      <div class="col-xs-12">
				  	...
				  	<b>Phone:</b> ' . $company_info['phone'] . '<br>
				  	<b>Sold By:</b> ' . $user_data['firstname'] . '<br>
			...
			$html .= ' 
			            ...
			            <tr>
			              <th><small><b>Net Amount:</b></small></th>
			              <td><small>' . $order_data['net_amount'] . '</td>
			            </tr>
			            <tr>
			              <th><small><b>Paid Status:</b></small></th>
			              <td><small>' . $paid_status . '</small></td>
			            </tr>
			          </table>
